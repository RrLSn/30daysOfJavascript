...
console.table(countriesAllAndDatas)


// 3. Use console.group() to group logs
console.group(countriesAllAndDatas)
...
console.warn('Fill all neccessary requirement')

// 3. Write an error message using console.error()
console.error('Fill all blank spaces')
